        ...
        case START_GUN:
            ...
            else
            {
                if (msg.data[0] == 1)
                {
                    ...
                    while ((info.str.base_time.tv_sec + info.str.base_time.tv_nsec / 1000000000) < (msg.head.send_time.tv_sec + msg.head.send_time.tv_nsec / 1000000000 + info.str.start_time))
                    {
                        clock_gettime(CLOCK_MONOTONIC, &info.str.base_time);
                    }
